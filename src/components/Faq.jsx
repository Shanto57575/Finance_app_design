	...
	return (
		<div className="my-20 space-y-5">
			...
			<div className="lg:flex items-center gap-x-5">
				...
				<div className="p-8 rounded-md my-3 lg:my-0 hover:bg-gradient-to-r from-red-400 via-red-300 to-red-200">
